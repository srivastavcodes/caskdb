...
// 	}()
// 	stat := db2.Stat()
// 	assert.Equal(t, 300, stat.KeyCount)
// }
//
...
// 		assert.NoError(t, err)
// 		assert.Len(t, utils.RandomBytes(128), len(val))
// 	}
// 	generateData(t, db, 200, 300, KB)
// 	for i := 200; i < 300; i++ {
// 		val, err := db.Get(utils.GetTestKey(i))
// 		assert.NoError(t, err)
// 		assert.Len(t, utils.RandomBytes(KB), len(val))
// 	}
// 	generateData(t, db, 400, 500, 4*KB)
// 	for i := 400; i < 500; i++ {
// 		val, err := db.Get(utils.GetTestKey(i))
// 		assert.NoError(t, err)
// 		assert.Len(t, utils.RandomBytes(4*KB), len(val))
// 	}
// }
//
...
// 	defer destroyDB(db)
//
// 	err = db.Put([]byte("aacd"), utils.RandomBytes(10))
// 	assert.NoError(t, err)
//
...
//
// 	err = db.Put([]byte("bbde"), utils.RandomBytes(10))
// 	assert.NoError(t, err)
// 	err = db.Put([]byte("cdea"), utils.RandomBytes(10))
// 	assert.NoError(t, err)
// 	err = db.Put([]byte("bcae"), utils.RandomBytes(10))
// 	assert.NoError(t, err)
//
...
// 	}
//
// 	err = db.PutWithTTL([]byte("bbde"), utils.RandomBytes(10), time.Millisecond*500)
// 	assert.NoError(t, err)
// 	err = db.Put([]byte("cdea"), utils.RandomBytes(10))
// 	assert.NoError(t, err)
// 	err = db.Put([]byte("bcae"), utils.RandomBytes(10))
...
// 	err = db.Put([]byte("bbde"), utils.RandomBytes(10))
// 	assert.NoError(t, err)
// 	err = db.PutWithTTL([]byte("cdea"), utils.RandomBytes(10), time.Millisecond*500)
// 	assert.NoError(t, err)
// 	err = db.PutWithTTL([]byte("bcae"), utils.RandomBytes(10), time.Millisecond*500)
// 	assert.NoError(t, err)
//
// 	time.Sleep(time.Millisecond * 600)
//
...
// 	assert.NoError(t, err)
// 	assert.Equal(t, 0, db.Stat().KeyCount)
// }
//
...
// 		err = db.DeleteExpiredKeys(time.Second * 2)
// 		assert.NoError(t, err)
// 		assert.Equal(t, 10000, db.Stat().KeyCount)
// 	}
// }
//
...
// 	stat := db.Stat()
// 	assert.Equal(t, 500, stat.KeyCount)
//
// 	_ = db.Close()
//
// 	// Reopen
...
// 	stat2 := db2.Stat()
// 	assert.Equal(t, 500, stat2.KeyCount)
//
// 	// Verify data
// 	for i := 0; i < 500; i++ {
